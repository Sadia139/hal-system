...
<div class="container">
  <a class="navbar-brand" href="#">Bonolota Hall BAUET</a>
...
<br>
 <h1 style="font-size:2vw; text-align: center;">About HALL</h1>
          <hr class="divider my-4" />
<img src="assets/img/hall.jpg" alt="Bonolota Hall" style="display: block; margin-left: auto; margin-left: auto; margin-right: auto;width: 50%; height: auto;">
<br>
<div style=" padding: 70px 0; border: 3px solid green;text-align: center;">
  <p>This is a six storeyed hall for the accommodation of male/female students of BAUET.The hall provides various facilities for the comfort and pleasure of the students, such as modern building and room with tiles, steel cot, mattress, shoe rack, modern toilet, geyser, Wi-fi facility, newspaper, hygienic kitchen and dining room, purified water, TV with other indoor and outdoor recreational facilities, standard cook and hygienic food at competitive price, CC TV, PA system, biometric exit and entry machine, 24/7 hours security, prayer room, reading room, standby generator, and medical facility.</p>
</div>
 <!-- The Modal -->
